...
import type { CaptchaData, CaptchaSolutionCommitment, CaptchaStatus, Dapp, DappAccounts, Error, GovernanceStatus, Payee, Provider, ProviderAccounts, ProviderMap, RandomProvider, User } from './prosopo';
